...
stagingup:
	docker compose -p $(PROJECT_NAME)-staging --env-file .env -f ./docker/docker-compose.staging.yml up -d

stagingb:
	docker compose -p $(PROJECT_NAME)-staging --env-file .env -f ./docker/docker-compose.staging.yml build

stagingdown:
	docker compose -p $(PROJECT_NAME)-staging --env-file .env -f ./docker/docker-compose.staging.yml down

stagingdownv:
	docker compose -p $(PROJECT_NAME)-staging --env-file .env -f ./docker/docker-compose.staging.yml down -v
