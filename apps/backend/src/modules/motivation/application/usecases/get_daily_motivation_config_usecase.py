...
class GetDailyMotivationConfigUseCase:
    """
    Use case for getting daily motivation config.
    """
    ...
    async def execute(
        ...
        """
        try:
            return await self.daily_motivation_config_domain_service.get_or_create_default_config(
            ...
            raise ServerError(
                error="An error occurred while getting daily motivation config",
