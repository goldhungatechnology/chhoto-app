...
class ListSystemMotivationQuotesUseCase:
    """
    Use case for listing global system/sample motivation quotes.
    """
    ...
    async def execute(
        ...
        """
        try:
            return await self.motivation_quote_domain_service.list_system_quotes(
            ...
            raise ServerError(
                error="An error occurred while listing system motivation quotes",
